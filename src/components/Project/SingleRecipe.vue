...
<div class="recipe-details">
  ...
  <p class="recipe-date">{{ recipes?.recipe?.date }}</p>
...
.recipe-details {
background-color: #f5f5f5; /* Set recipe details background color */
border-radius: 5px;
...
.btn-primary {
background-color: #ff8c42; /* Set primary button background color */
color: #fff; /* Set primary button text color */
}

.btn-danger {
background-color: #ff6b0f; /* Set danger button background color */
color: #fff; /* Set danger button text color */
}
</style>