<template>
    <h1>HomePage</h1>
    <p><button><router-link :to="'/login'">Login</router-link></button></p>
    ...
    <p><button><router-link :to="'/MealPlanApi'">Customise Your Weekly Meal Plans!</router-link></button></p>
</template>
<script>
...
/* Style the router links within buttons */
router-link {
...
/* Style the button containers (paragraphs) */
p {
    text-align: center;
}
</style>